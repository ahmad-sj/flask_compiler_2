...
| `SemanticAnalyzer` | يمرّ على الشجرة لتنفيذ ١٤ فحصاً (١٢٨٣ سطراً) |
...
أضف `--quiet-ast` لإيقاف الطباعة على الطرفية (تُكتب ملفات `.txt` في الحالتين).
...
- ٢٤ فحصاً — التقاط كل حالة خطأ دلالي **ومنع** التوليد عندها
